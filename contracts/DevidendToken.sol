...
contract DividendTokenTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DevidendToken contract."
        );
    }
...
contract DevidendToken is ERC20, BaseToken {
    using SafeMath for uint256;
    ...
    DividendTokenTracker public dividendTracker;
    ...
    constructor(
        ...
        uint256 serviceFee_
    ) payable ERC20(name_, symbol_, decimals_, totalSupply_, owner_) {
        rewardToken = addrs[0];
        ...
        dividendTracker = DividendTokenTracker(
        ...
        */
        ...
        emit TokenCreated(owner(), address(this), TokenType.Devidend, VERSION);
    ...
    function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(
            ...
            "DevidendToken: Amount must be greater than 0.001% of total supply"
        );
    ...
    function excludeFromFees(address account) external onlyOwner {
        require(
            ...
            "DevidendToken: Account is already excluded"
        );
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner {
        require(
            wallet != address(0),
            "DevidendToken: The marketing wallet cannot be the value of zero"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "DevidendToken: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "DevidendToken: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "DevidendToken: Cannot update gasForProcessing to same value"
        );
...
contract TokenFactory {
    ...
    function createStandardToken(
        ...
        DevidendToken _token = new DevidendToken(
        _tokenName,
        _tokenSymbol,
        totalSupply_,
       decimals_,
